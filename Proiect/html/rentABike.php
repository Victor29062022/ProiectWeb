...
<head>
    ...
    <title>Renting Servises | Orange Bikes</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <button class="buttonOnCurentPage">Renting</button>
        ...
        <a href="shoppingCart.php"><button class="button">Shopping Cart</button></a>
    ...
    <p>Select what service do you want to rent</p>
    ...
    <h1>Select region</h1>
    <div id="select">
                <select name="countySelect" id="selectCounty" onchange="selectSubCat()">
